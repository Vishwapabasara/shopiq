  ...
  return (
    <div className="card px-6 py-8 flex flex-col items-center gap-4">
      ...
      <div className="text-center">
        <p className="text-sm font-semibold text-zinc-700">Analysing your orders…</p>
        {ordersAnalyzed > 0 && (
          <p className="text-xs text-zinc-400 mt-1">{ordersAnalyzed} orders processed so far</p>
        )}
      </div>
      ...
      <p className="text-xs text-zinc-400">Fetching 90 days of order history from Shopify</p>
    </div>
  )
}
